...
class PagerFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        PagerFragment.newInstance("asdasd", "asdasd")
    }
    ...
    override fun onCreateView(
        ...
        PagerFragment.newInstance("asdad", "asdasd")
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        PagerFragment.newInstance("asdasd", "sdasd")
        vpClass2.adapter = AdapterOne(childFragmentManager)
        PagerFragment.newInstance("asdasd", "adsasd")
